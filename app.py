...
def main():
    ...
    with st.container():
        ...
        # Build cards list string explicitly on ONE LINE to avoid markdown code block interpretation
        cards_html = ""
        ...
        # Final HTML wrapper
        final_html = f'<div class="dashboard-container">{cards_html}</div>'
