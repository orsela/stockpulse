# app.py - StockPulse v2.0 - עיצוב מושלם + רספונסיבי + ללא באגים
...
def apply_custom_ui():
    ...
    <style>
        ...
        .target-big { font-size: 1.4rem; font-weight: bold; color: #00E676; }
    </style>
            ...
            if active.empty:
                ...
                if view == "Table":
                    for idx, row in active.iterrows():
                        ...
                        color = "#00E676" if row['direction']=="Up" else "#FF4B4B"

                        e_col, d_col = st.columns([1,1])
                        edit = e_col.button("Edit", key=f"edit_{idx}")
                        delete = d_col.button("Delete", key=f"del_{idx}")
                        ...
                        <div class="alert-card" style="border-left-color:{color}">
                            <div style="display:flex; justify-content:space-between; align-items:center;">
                                ...
                                <div style="text-align:right;">
                                    <div style="color:#aaa;">${curr:.2f}</div>
